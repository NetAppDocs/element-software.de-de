...
.Element vCenter Plug-in 5.0 oder höher
--
Sie führen einen Management-Node aus, der bereits ausgeführt wurde link:task_hcc_upgrade_management_node.html["Upgrade durchgeführt"] Auf Version 12.3.x oder höher.
