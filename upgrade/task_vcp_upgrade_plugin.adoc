...
+
Beginnend mit dem Element Plug-in für vCenter Server 5.0, dem NetApp Element Remote Plugin Extension Point:
...
+
Element Plug-in für vCenter Server 4.10 oder früher, NetApp Element-Konfigurations- und Management-Erweiterungspunkte:
