...
[role="lead"]
Sie können das verwenden `GetAPI` Methode zum Abrufen einer Liste aller API-Methoden und unterstützten API-Endpunkte, die im System verwendet werden können.
